...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'task-own',
                loadChildren: () => __webpack_require__.e(/*! import() | own-task-own-task-module */ "own-task-own-task-module").then(__webpack_require__.bind(null, /*! ../own-task/own-task.module */ "./src/app/pages/own-task/own-task.module.ts")).then(m => m.OwnTaskPageModule)
            },
            {
                path: 'setting',
