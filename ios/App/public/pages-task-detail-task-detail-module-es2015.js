...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TaskDetailLogicService", function() { return TaskDetailLogicService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _service_task_detail_service_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../service/task-detail-service.service */ "./src/app/pages/task-detail/service/task-detail-service.service.ts");
...
let TaskDetailLogicService = class TaskDetailLogicService {
    constructor(taskDetailService) {
        this.taskDetailService = taskDetailService;
    }
    fetchAnyTask(taskId) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["from"])(this.taskDetailService.getTask(taskId));
    }
    fetchMessagePerTask(taskId) {
        const filterContent = {
            taskID: {
                eq: `${taskId}`
            }
    ...
    sendNewMessage(taskId, messageContent) {
        const inputContent = {
...
TaskDetailLogicService.ctorParameters = () => [
    { type: _service_task_detail_service_service__WEBPACK_IMPORTED_MODULE_2__["TaskDetailServiceService"] }
];
TaskDetailLogicService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_service_task_detail_service_service__WEBPACK_IMPORTED_MODULE_2__["TaskDetailServiceService"]])
], TaskDetailLogicService);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TaskDetailServiceService", function() { return TaskDetailServiceService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
let TaskDetailServiceService = class TaskDetailServiceService {
...
TaskDetailServiceService.ctorParameters = () => [
    { type: _shared_service_amplify_service__WEBPACK_IMPORTED_MODULE_2__["AmplifyService"] }
];
TaskDetailServiceService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    }),
...
/* harmony import */ var _logic_task_detail_logic_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./logic/task-detail-logic.service */ "./src/app/pages/task-detail/logic/task-detail-logic.service.ts");
/* harmony import */ var src_app_shared_component_modal_add_task_modal_add_task_modal_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/shared/component/modal/add-task-modal/add-task-modal.component */ "./src/app/shared/component/modal/add-task-modal/add-task-modal.component.ts");
...
let TaskDetailPage = class TaskDetailPage {
    constructor(location, logic, route, scroll, modalCtrl, actionSheetCtrl, toastCtrl, platform) {
    ...
    doneTask(taskDetail) {
        ...
        this.logic.updateTaskItem(taskDetail, 10)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["flatMap"])(() => this.logic.fetchAnyTask(taskDetail.id)))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["tap"])(() => presentToast)).subscribe((data) => this.taskDetail = data);
    }
    moveTask(taskDetail) {
        const presentToast = Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["from"])(this.presentMoveTask());
        this.logic.updateTaskItem(taskDetail, 0)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["flatMap"])(() => this.logic.fetchAnyTask(taskDetail.id)))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["tap"])(() => presentToast)).subscribe((data) => this.taskDetail = data);
    }
    presentActionSheet(taskDetail) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const activeActionSheet = yield this.actionSheetCtrl.create({
            ...
            const doneActionSheet = yield this.actionSheetCtrl.create({
                cssClass: 'my-custom-class',
                buttons: [
                    {
                        text: 'Activeに移動',
            ...
            if (this.segment === 'active') {
                yield activeActionSheet.present();
            }
            else if (this.segment === 'done') {
                yield doneActionSheet.present();
            }
        });
    }
...
], TaskDetailPage.prototype, "child", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
], TaskDetailPage.prototype, "content", void 0);
TaskDetailPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_common__WEBPACK_IMPORTED_MODULE_2__["Location"],
        _logic_task_detail_logic_service__WEBPACK_IMPORTED_MODULE_6__["TaskDetailLogicService"],
